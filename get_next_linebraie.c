...
/*   Updated: 2024/04/25 13:17:14 by elefonta         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	int			nbyte; // nbr carat a lire
	char		*tamp; //variable tampon ou on stock temporaorement ce quon a read
	static char	*buffrest; // le reste a lire
	char		*ret; //ce quodoit retourner
